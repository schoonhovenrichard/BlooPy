...
import bloopy.algorithms.pso_pyswarms as pso
...
## Run Particle Swarm Optimization (100,50)
nr_parts = 100
k = 50 # Should be less than nr_parts
# Scaled parameters equidistant to [0,scaling],
# Strangely, [0,1] is not necessarily the same as e.g. [0,100]
# for the pyswarms library
# NOTE: Users should try None, 1, 10, 100, 1000
scaling = 100

test_pso = pso.pyswarms_pso(fitness_func,
        1,
        searchspace,
