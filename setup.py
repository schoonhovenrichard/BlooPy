...
setup(
    ...
    version = '0.4.2',  # Ideally should be same as your GitHub release tag varsion
    ...
    download_url = 'https://github.com/schoonhovenrichard/BlooPy/archive/refs/tags/0.4.2.tar.gz',
